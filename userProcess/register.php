  ...
  <div  style="width: 100%; height: 100vh; ">
    <?php
      ...
      if($_SERVER['REQUEST_METHOD'] == "POST") {
        ...
        if($isCreat) {
            header("location: https://localhost/php-database-project/?page=user");
        } else {
    ...
    <div class="p-4 ">
        <form action="#" method="post" class="rounded-lg col-lg-5 col-md-4 m-auto bg-none border border-dark p-3" enctype="multipart/form-data">
            ...
            <div class="form-row">
                <div class="col-5">
                    <a href="https://localhost/php-database-project/?page=event"><button type="submit"  class="btn btn-success w-100 fa fa-user"aria-hidden="true">Register</button></a>
                </div>
